  ...
  if (bookings.length === 0) {
    return (
      <div className="w-full max-w-2xl bg-white dark:bg-zinc-900 rounded-lg shadow-lg p-6">
        <h3 className="text-lg font-semibold mb-4">Mina bokningar</h3>
    ...
    <div className="w-full max-w-2xl bg-white dark:bg-zinc-900 rounded-lg shadow-lg p-6">
      ...
      <div className="space-y-3">
        {sortedBookings.map((booking) => (
          <div
            key={booking.id}
            className="flex items-start gap-4 p-4 bg-zinc-50 dark:bg-zinc-800 rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-750 transition-colors"
          >
              ...
              <div className="flex items-start justify-between gap-2">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-shrink-0 p-2 text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition-colors"
